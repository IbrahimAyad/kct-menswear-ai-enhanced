          ...
          <div>
            ...
            >
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Perfectly Curated.
                <br />
                <span className="text-gold">Professionally Styled.</span>
                <br />
                Personally Yours.
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Link
                  href="#bundles"
                  className="inline-flex items-center justify-center px-8 py-4 bg-gold text-black rounded-lg font-semibold hover:bg-gold/90 transition-colors"
                >
                  Shop Bundles
                </Link>
                <Link
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-8">
                    ...
                    <p className="text-gray-300 mb-4">
                      ...
                      {featuredBundles[currentIndex].tie.color}
                    </p>
