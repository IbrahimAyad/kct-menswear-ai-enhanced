...
import { AIMessage, ChatMessage, getBufferString, HumanMessage, SystemMessage, } from "@langchain/core/messages";
...
export const zepMemoryToMessages = (memory) => {
    const systemPrompt = zepMemoryContextToSystemPrompt(memory);
    ...
    if (memory && memory.messages) {
        messages = messages.concat(memory.messages
            ...
            if (roleType === "user") {
                ...
                return new ChatMessage(messageContent, (roleType ?? role));
            }
        }));
    }
    return messages;
