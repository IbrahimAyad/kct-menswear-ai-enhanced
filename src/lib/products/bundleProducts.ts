...
export const bundleProducts = {
  bundles: [
    ...
    },
    {
      ...
      imageUrl: 'https://pub-46371bda6faf4910b74631159fc2dfd4.r2.dev/kct-prodcuts/Bundles-Augest-2025/Bundles-01/navy-suit-white-burgundy.png',
    ...
    },
    {
      ...
      bundlePrice: 564.99,
      savings: 98.98,
      description: 'Timeless elegance. The burgundy tie adds depth to the classic navy suit.',
      occasions: ['Wedding Guest', 'Business Formal', 'Evening Reception', 'Anniversary'],
      trending: true,
      seasonal: 'year-round',
      aiScore: 98
    },
