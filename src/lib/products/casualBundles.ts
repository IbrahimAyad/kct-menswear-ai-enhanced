...
export const casualBundles = {
  bundles: [
    // NAVY BUNDLES
    {
      ...
      imageUrl: `${R2_BASE_URL}/kct-prodcuts/casual-bundles/Navy-Suit-Lilac-Shirt-lilac-pocketsqaure.png`,
    ...
    },
    {
      ...
      imageUrl: `${R2_BASE_URL}/kct-prodcuts/casual-bundles/navy-suit-pink-shirt-pink-pocket-sqaure.png`,
      originalPrice: 249.99,
      bundlePrice: 199.99,
      savings: 50.00,
    ...
    },
    {
      ...
      imageUrl: `${R2_BASE_URL}/kct-prodcuts/casual-bundles/navy-black-shirt-black-pocket-sqaure.png`,
      originalPrice: 249.99,
      bundlePrice: 199.99,
      savings: 50.00,
    ...
    },
    {
      ...
      imageUrl: `${R2_BASE_URL}/kct-prodcuts/casual-bundles/navy-white-shirt-white-pocket-sqaure.png`,
      originalPrice: 249.99,
      bundlePrice: 199.99,
      savings: 50.00,
    ...
    // BLACK BUNDLES
    {
      ...
      pocketSquare: { color: 'Black', pattern: 'Solid' as const },
      imageUrl: `${R2_BASE_URL}/kct-prodcuts/casual-bundles/black-suit-black-shirt.png`,
      originalPrice: 249.99,
      bundlePrice: 199.99,
      savings: 50.00,
    ...
    },
    {
      ...
      imageUrl: `${R2_BASE_URL}/kct-prodcuts/casual-bundles/black-suit-burgundy-shirt-burgundy-pocket-sqaure.png`,
      originalPrice: 249.99,
      bundlePrice: 199.99,
      savings: 50.00,
    ...
    },
    {
      ...
      imageUrl: `${R2_BASE_URL}/kct-prodcuts/casual-bundles/black-suit-emerlad-green-shirt-emerlad-green-pocket-sqaure.png`,
      originalPrice: 249.99,
      bundlePrice: 199.99,
      savings: 50.00,
    ...
    },
    {
      ...
      imageUrl: `${R2_BASE_URL}/kct-prodcuts/casual-bundles/black-suit-hunter-green-shirt-hunter-green-pocket-sqaure.png`,
      originalPrice: 249.99,
      bundlePrice: 199.99,
      savings: 50.00,
    ...
    },
    {
      ...
      shirt: { color: 'White', fit: 'Classic' as const },
      pocketSquare: { color: 'White', pattern: 'Solid' as const },
      imageUrl: `${R2_BASE_URL}/kct-prodcuts/casual-bundles/black-white-shirt-white-pocket-sqaure.png`,
      originalPrice: 249.99,
      bundlePrice: 199.99,
      savings: 50.00,
    ...
    // LIGHT GREY BUNDLES
    {
      ...
      imageUrl: `${R2_BASE_URL}/kct-prodcuts/casual-bundles/light-grey-suit-light-blue-shirt-light-blue-pocket-sqaure.png`,
      originalPrice: 249.99,
      bundlePrice: 199.99,
      savings: 50.00,
    ...
    },
    {
      ...
      shirt: { color: 'White', fit: 'Classic' as const },
      pocketSquare: { color: 'White', pattern: 'Solid' as const },
      imageUrl: `${R2_BASE_URL}/kct-prodcuts/casual-bundles/light-grey-white-shirt-white-pocket-sqaure.png`,
      originalPrice: 249.99,
      bundlePrice: 199.99,
      savings: 50.00,
    ...
    // INDIGO BUNDLES
    {
      ...
      shirt: { color: 'Black', fit: 'Slim' as const },
      pocketSquare: { color: 'White', pattern: 'Solid' as const },
      imageUrl: `${R2_BASE_URL}/kct-prodcuts/casual-bundles/indigo-black-shirt-white-pocket-sqaure.png`,
      originalPrice: 249.99,
      bundlePrice: 199.99,
      savings: 50.00,
    ...
    },
    {
      ...
      shirt: { color: 'White', fit: 'Classic' as const },
      pocketSquare: { color: 'White', pattern: 'Solid' as const },
      imageUrl: `${R2_BASE_URL}/kct-prodcuts/casual-bundles/indigo-white-shirt-white-pocket-sqaure.png`,
      originalPrice: 249.99,
      bundlePrice: 199.99,
      savings: 50.00,
    ...
    // MIDNIGHT BLUE & FRENCH BLUE
    {
      ...
      pocketSquare: { color: 'White', pattern: 'Solid' as const },
      imageUrl: `${R2_BASE_URL}/kct-prodcuts/casual-bundles/midnight-blue--white-shirt-white-pocket-sqaure.png`,
      originalPrice: 249.99,
      bundlePrice: 199.99,
      savings: 50.00,
    ...
    },
    {
      ...
      shirt: { color: 'Black', fit: 'Slim' as const },
      pocketSquare: { color: 'Black', pattern: 'Solid' as const },
      imageUrl: `${R2_BASE_URL}/kct-prodcuts/casual-bundles/french-blue-black-shirt-black-pocket-sqaure.png`,
      originalPrice: 249.99,
      bundlePrice: 199.99,
      savings: 50.00,
